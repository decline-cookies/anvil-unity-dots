...
{
    /// <summary>
    /// An interface that describes an access controlled value that grants shared write access.
    /// </summary>
    /// <typeparam name="T">The type of value being access controlled.</typeparam>
    public interface ISharedWriteAccessControlledValue<T> : IAnvilDisposable
    {
        /// <summary>
        /// Acquires the <see cref="T"/> instance synchronously for Shared Write access and returns the controlled instance.
        ///
        /// This is the preferred method of synchronous value access vs
        /// <see cref="AcquireSharedWrite"/>/<see cref="ISharedWriteAccessControlledValue{T}.Release"/>.
        /// </summary>
        /// <remarks>
        ...
        /// </remarks>
        /// <example>using var valueHandle = myAccessControlledValue.AcquireWithSharedWriteHandle();</example>
        /// <returns>
        /// The <see cref="AccessControlledValue{T}.AccessHandle"/> that maintains access to the controlled value until
        /// disposed.
        /// </returns>
        public AccessControlledValue<T>.AccessHandle AcquireWithSharedWriteHandle();

        /// <summary>
        /// Acquires the <see cref="T"/> instance synchronously for Shared Write access.
        ...
        /// <summary>
        /// Acquires the <see cref="T"/> instance asynchronously for Shared Write access.
