...
{
    /// <summary>
    /// An interface that describes an access controlled value that grants exclusive write access.
    /// </summary>
    /// <typeparam name="T">The type of value being access controlled.</typeparam>
    public interface IExclusiveWriteAccessControlledValue<T> : IAnvilDisposable
    {
        /// <summary>
        /// Acquires the <see cref="T"/> instance synchronously for Exclusive Write access and returns the instance.
        /// This is the preferred method of synchronous value access vs
        /// <see cref="AcquireExclusiveWrite"/>/<see cref="IExclusiveWriteAccessControlledValue{T}.Release"/>.
        /// </summary>
        /// <remarks>
        ...
        /// </remarks>
        /// <example>using var valueHandle = myAccessControlledValue.AcquireWithExclusiveWriteHandle();</example>
        /// <returns>
        /// The <see cref="AccessControlledValue{T}.AccessHandle"/> that maintains access to the controlled value until disposed.
        /// </returns>
        public AccessControlledValue<T>.AccessHandle AcquireWithExclusiveWriteHandle();

        /// <summary>
        /// Acquires the <see cref="T"/> instance synchronously for Exclusive Write access.
        ...
        /// <summary>
        /// Acquires the <see cref="T"/> instance asynchronously for Exclusive Write access.
