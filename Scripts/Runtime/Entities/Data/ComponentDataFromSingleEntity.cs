...
namespace Anvil.Unity.DOTS.Entities
{
    ...
    public readonly struct ComponentDataFromSingleEntity<T> where T : unmanaged, IComponentData
    {
        ...
        public ComponentDataFromSingleEntity(ComponentLookup<T> lookup, Entity entity)
        {
            m_Lookup = lookup;
            m_Entity = entity;
        }
