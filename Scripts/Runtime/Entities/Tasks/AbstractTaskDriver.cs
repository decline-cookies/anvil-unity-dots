...
// {
//     //TODO: DOCS
//     public abstract class AbstractTaskDriver<TTaskDriverSystem, TResultDestinationType> : AbstractTaskDriver,
//                                                                                           ITaskDriver
//         where TTaskDriverSystem : AbstractTaskSystem<>
//         where TResultDestinationType : Enum
//     {
//         private AbstractProxyDataStream m_ResultsData;
//
...
//         }
//
//         protected AbstractTaskDriver(World world, AbstractTaskSystem<> system)
//         {
//             World = world;
//             System = system;
//             
//             //Generate a Unique ID for this TaskDriver relative to its System
//             m_Context = System.RegisterTaskDriver(this);
//             
