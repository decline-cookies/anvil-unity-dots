...
{
    internal class ProxyDataStreamScheduleInfo<TInstance> : IScheduleInfo
        where TInstance : unmanaged, IProxyInstance
    {
        ...
        public ProxyDataStreamScheduleInfo(ProxyDataStream<TInstance> data, BatchStrategy batchStrategy)
        {
