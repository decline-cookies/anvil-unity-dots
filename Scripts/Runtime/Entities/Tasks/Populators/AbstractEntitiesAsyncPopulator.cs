...
{
    public abstract class AbstractEntitiesAsyncPopulator<TKey, TSource, TResult> : AbstractPopulator<TKey, TSource, TResult>
        where TKey : struct, IEquatable<TKey>
        where TSource : struct, ILookupValue<TKey>
        where TResult : struct, ILookupValue<TKey>
    {
        public abstract JobHandle PopulateAsync(JobHandle dependsOn, JobEntitiesSourceWriter<TSource> sourceWriter, JobResultWriter<TResult> resultWriter);
