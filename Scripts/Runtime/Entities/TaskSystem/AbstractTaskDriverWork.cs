...
{
    internal abstract class AbstractTaskDriverWork : AbstractAnvilBase
    {
        ...
        private static readonly MethodInfo PROTOTYPE_DATA_STREAM_METHOD = typeof(AbstractTaskDriverWork).GetMethod(nameof(CreateTypedDataStream), BindingFlags.Static | BindingFlags.NonPublic);
        ...
        protected AbstractTaskDriverWork(Type taskDriverType)
        {
