...
namespace Anvil.Unity.DOTS.Entities
{
    ...
    {
        private static readonly Dictionary<string, AbstractPersistentData> PERSISTENT_DATA_LOOKUP
            = new Dictionary<string, AbstractPersistentData>();
        ...
        public static void CreatePersistentData<T>(string id, T persistentData) where T : unmanaged
        {
        ...
        public static void CreateThreadPersistentData<T>(
            string id,
        ...
        public static void CreateEntityPersistentData<T>(
            string id,
        ...
        public static IPersistentData<T> AcquirePersistentData<T>(string id, AccessType accessType) where T : unmanaged
        {
        ...
        internal static ThreadPersistentData<T> GetThreadPersistentData<T>(string id) where T : unmanaged
        {
        ...
        internal static EntityPersistentData<T> GetEntityPersistentData<T>(string id) where T : unmanaged
        {
            if (!PERSISTENT_DATA_LOOKUP.TryGetValue(id, out AbstractPersistentData data))
            {
        ...
        internal static PersistentData<T> GetPersistentData<T>(string id) where T : unmanaged
        {
            if (!PERSISTENT_DATA_LOOKUP.TryGetValue(id, out AbstractPersistentData data))
            {
