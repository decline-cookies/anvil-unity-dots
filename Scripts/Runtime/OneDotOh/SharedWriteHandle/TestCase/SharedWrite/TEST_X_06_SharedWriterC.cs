...
namespace Anvil.Unity.DOTS.TestCase.SharedWrite
{
    ...
    [UpdateAfter(typeof(TEST_X_05_SharedWriterB))]
    [BurstCompile]
    public partial struct TEST_X_06_SharedWriterC : ISystem
    {
        private static readonly ProfilerMarker s_ProfilerMarker = new ProfilerMarker($"{nameof(TEST_X_06_SharedWriterC)}");
