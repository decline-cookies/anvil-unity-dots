...
namespace Anvil.Unity.DOTS.TestCase.SharedWrite
{
    ...
    [UpdateAfter(typeof(TEST_X_06_SharedWriterC))]
    [BurstCompile]
    public partial struct TEST_X_07_ExclusiveWriterB : ISystem
    {
        private static readonly ProfilerMarker s_ProfilerMarker = new ProfilerMarker($"{nameof(TEST_X_07_ExclusiveWriterB)}");
