...
namespace Anvil.Unity.DOTS.TestCase.SharedWrite
{
    ...
    [UpdateAfter(typeof(TEST_X_17_SharedReader0))]
    [BurstCompile]
    public partial struct TEST_X_18_SharedReader1 : ISystem
    {
        private static readonly ProfilerMarker s_ProfilerMarker = new ProfilerMarker($"{nameof(TEST_X_18_SharedReader1)}");
