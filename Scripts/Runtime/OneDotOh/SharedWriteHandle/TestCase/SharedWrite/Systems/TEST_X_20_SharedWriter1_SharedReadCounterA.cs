...
namespace Anvil.Unity.DOTS.TestCase.SharedWrite
{
    ...
    [UpdateAfter(typeof(TEST_X_19_SharedWriter0_SharedReadCounterA))]
    [BurstCompile]
    public partial struct TEST_X_20_SharedWriter1_SharedReadCounterA : ISystem
    {
        private static readonly ProfilerMarker s_ProfilerMarker = new ProfilerMarker($"{nameof(TEST_X_20_SharedWriter1_SharedReadCounterA)}");
        ...
        public void OnUpdate(ref SystemState state)
        {
            ...
            // Debug.Log("TEST_X_20_SharedWriter1_SharedReadCounterA");
