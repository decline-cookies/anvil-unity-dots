...
namespace Anvil.Unity.DOTS.TestCase.SharedWrite
{
    ...
    [UpdateAfter(typeof(TEST_Y_03_SharedReader0))]
    [BurstCompile]
    public partial struct TEST_Y_04_SharedReader1 : ISystem
    {
        private static readonly ProfilerMarker s_ProfilerMarker = new ProfilerMarker($"{nameof(TEST_Y_04_SharedReader1)}");
