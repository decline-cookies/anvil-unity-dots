...
namespace Anvil.Unity.DOTS.TestCase.SharedWrite
{
    ...
    [UpdateAfter(typeof(TEST_X_24_SharedWriter1_ExclusiveWriterCounterA))]
    [BurstCompile]
    public partial struct TEST_X_25_SharedReader0 : ISystem
    {
        private static readonly ProfilerMarker s_ProfilerMarker = new ProfilerMarker($"{nameof(TEST_X_25_SharedReader0)}");
