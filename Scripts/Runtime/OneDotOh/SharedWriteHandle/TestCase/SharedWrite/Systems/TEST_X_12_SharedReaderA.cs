...
namespace Anvil.Unity.DOTS.TestCase.SharedWrite
{
    ...
    [UpdateAfter(typeof(TEST_X_11_SharedWriterB))]
    [BurstCompile]
    public partial struct TEST_X_12_SharedReaderA : ISystem
    {
        private static readonly ProfilerMarker s_ProfilerMarker = new ProfilerMarker($"{nameof(TEST_X_12_SharedReaderA)}");
