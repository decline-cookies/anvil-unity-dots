...
namespace Anvil.Unity.DOTS.TestCase.SharedWrite
{
    ...
    [UpdateAfter(typeof(TEST_X_08_SharedWriter0))]
    [BurstCompile]
    public partial struct TEST_X_09_SharedWriter2 : ISystem
    {
        private static readonly ProfilerMarker s_ProfilerMarker = new ProfilerMarker($"{nameof(TEST_X_09_SharedWriter2)}");
        ...
        {
            // Debug.Log("TEST_X_09_SharedWriter2");
