...
namespace Anvil.Unity.DOTS.TestCase.SharedWrite
{
    ...
    [UpdateAfter(typeof(TEST_Y_05_SharedWriter1))]
    [BurstCompile]
    public partial struct TEST_Y_06_SharedWriter2 : ISystem
    {
        private static readonly ProfilerMarker s_ProfilerMarker = new ProfilerMarker($"{nameof(TEST_Y_06_SharedWriter2)}");
        ...
        {
            // Debug.Log("TEST_Y_06_SharedWriter2");
