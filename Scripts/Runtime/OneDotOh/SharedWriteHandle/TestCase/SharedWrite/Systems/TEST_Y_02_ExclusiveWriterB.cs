...
namespace Anvil.Unity.DOTS.TestCase.SharedWrite
{
    ...
    [UpdateAfter(typeof(TEST_Y_01_ExclusiveWriterA))]
    [BurstCompile]
    public partial struct TEST_Y_02_ExclusiveWriterB : ISystem
    {
        private static readonly ProfilerMarker s_ProfilerMarker = new ProfilerMarker($"{nameof(TEST_Y_02_ExclusiveWriterB)}");
