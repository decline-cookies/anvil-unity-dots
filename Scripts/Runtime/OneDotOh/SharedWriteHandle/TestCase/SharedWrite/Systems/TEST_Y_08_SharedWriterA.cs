...
namespace Anvil.Unity.DOTS.TestCase.SharedWrite
{
    ...
    [UpdateAfter(typeof(TEST_Y_07_ExclusiveWriterB))]
    [BurstCompile]
    public partial struct TEST_Y_08_SharedWriterA : ISystem
    {
        private static readonly ProfilerMarker s_ProfilerMarker = new ProfilerMarker($"{nameof(TEST_Y_08_SharedWriterA)}");
