...
namespace Anvil.Unity.DOTS.TestCase.SharedWrite
{
    ...
    [BurstCompile]
    public partial struct TEST_Y_01_ExclusiveWriter0 : ISystem
    {
        private static readonly ProfilerMarker s_ProfilerMarker = new ProfilerMarker($"{nameof(TEST_Y_01_ExclusiveWriter0)}");
