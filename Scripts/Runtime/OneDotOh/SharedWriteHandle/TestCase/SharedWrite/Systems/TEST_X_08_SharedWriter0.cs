...
namespace Anvil.Unity.DOTS.TestCase.SharedWrite
{
    ...
    [UpdateAfter(typeof(TEST_X_07_ExclusiveWriter1))]
    [BurstCompile]
    public partial struct TEST_X_08_SharedWriter0 : ISystem
    {
        private static readonly ProfilerMarker s_ProfilerMarker = new ProfilerMarker($"{nameof(TEST_X_08_SharedWriter0)}");
        ...
        {
            // Debug.Log("TEST_X_08_SharedWriter0");
