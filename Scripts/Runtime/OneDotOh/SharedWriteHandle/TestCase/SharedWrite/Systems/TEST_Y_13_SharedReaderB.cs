...
namespace Anvil.Unity.DOTS.TestCase.SharedWrite
{
    ...
    [UpdateAfter(typeof(TEST_Y_12_SharedReaderA))]
    [BurstCompile]
    public partial struct TEST_Y_13_SharedReaderB : ISystem
    {
        private static readonly ProfilerMarker s_ProfilerMarker = new ProfilerMarker($"{nameof(TEST_Y_13_SharedReaderB)}");
