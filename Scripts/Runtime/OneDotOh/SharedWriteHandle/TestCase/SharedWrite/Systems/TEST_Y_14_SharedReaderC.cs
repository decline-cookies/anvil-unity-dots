...
namespace Anvil.Unity.DOTS.TestCase.SharedWrite
{
    ...
    [UpdateAfter(typeof(TEST_Y_13_SharedReaderB))]
    [BurstCompile]
    public partial struct TEST_Y_14_SharedReaderC : ISystem
    {
        private static readonly ProfilerMarker s_ProfilerMarker = new ProfilerMarker($"{nameof(TEST_Y_14_SharedReaderC)}");
