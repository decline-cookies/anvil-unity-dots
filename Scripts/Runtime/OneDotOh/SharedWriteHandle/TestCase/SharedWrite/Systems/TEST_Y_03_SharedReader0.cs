...
namespace Anvil.Unity.DOTS.TestCase.SharedWrite
{
    ...
    [UpdateAfter(typeof(TEST_Y_02_ExclusiveWriter1))]
    [BurstCompile]
    public partial struct TEST_Y_03_SharedReader0 : ISystem
    {
        private static readonly ProfilerMarker s_ProfilerMarker = new ProfilerMarker($"{nameof(TEST_Y_03_SharedReader0)}");
