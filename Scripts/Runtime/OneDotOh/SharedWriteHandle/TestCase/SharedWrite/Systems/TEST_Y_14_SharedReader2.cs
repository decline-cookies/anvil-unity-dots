...
namespace Anvil.Unity.DOTS.TestCase.SharedWrite
{
    ...
    [UpdateAfter(typeof(TEST_Y_13_SharedReader1))]
    [BurstCompile]
    public partial struct TEST_Y_14_SharedReader2 : ISystem
    {
        private static readonly ProfilerMarker s_ProfilerMarker = new ProfilerMarker($"{nameof(TEST_Y_14_SharedReader2)}");
