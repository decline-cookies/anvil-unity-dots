...
namespace Anvil.Unity.DOTS.TestCase.SharedWrite
{
    ...
    [UpdateAfter(typeof(TEST_X_14_SharedReader2))]
    [BurstCompile]
    public partial struct TEST_X_15_SharedWriter0_ExclusiveWriterCounterA : ISystem
    {
        private static readonly ProfilerMarker s_ProfilerMarker = new ProfilerMarker($"{nameof(TEST_X_15_SharedWriter0_ExclusiveWriterCounterA)}");
        ...
        public void OnUpdate(ref SystemState state)
        {
            ...
            // Debug.Log("TEST_X_15_SharedWriter0_ExclusiveWriterCounterA");
