...
namespace Anvil.Unity.DOTS.TestCase.SharedWrite
{
    ...
    [UpdateAfter(typeof(TEST_X_14_SharedReaderC))]
    [BurstCompile]
    public partial struct TEST_X_15_SharedWriteExclusiveCounterA : ISystem
    {
        private static readonly ProfilerMarker s_ProfilerMarker = new ProfilerMarker($"{nameof(TEST_X_15_SharedWriteExclusiveCounterA)}");
