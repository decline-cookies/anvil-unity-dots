...
namespace Anvil.Unity.DOTS.TestCase.SharedWrite
{
    ...
    [UpdateAfter(typeof(TEST_X_04_SharedReader1))]
    [BurstCompile]
    public partial struct TEST_X_05_SharedWriter1 : ISystem
    {
        private static readonly ProfilerMarker s_ProfilerMarker = new ProfilerMarker($"{nameof(TEST_X_05_SharedWriter1)}");
        ...
        {
            // Debug.Log("TEST_X_05_SharedWriter1");
