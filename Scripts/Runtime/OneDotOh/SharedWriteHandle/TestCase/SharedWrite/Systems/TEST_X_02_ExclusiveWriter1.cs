...
namespace Anvil.Unity.DOTS.TestCase.SharedWrite
{
    ...
    [UpdateAfter(typeof(TEST_X_01_ExclusiveWriter0))]
    [BurstCompile]
    public partial struct TEST_X_02_ExclusiveWriter1 : ISystem
    {
        private static readonly ProfilerMarker s_ProfilerMarker = new ProfilerMarker($"{nameof(TEST_X_02_ExclusiveWriter1)}");
